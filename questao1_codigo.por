//Algoritmo: caixa eletrÃ´nico
//DescriÃ§Ã£o: o algoritmo recebe o nÃºmero de notas de 100, de 50, de 20, de 10, de 5, de 2 disponÃ­veis em um caixa 
//e o valor que se deseja sacar; depois, deve indicar quantas notas serÃ£o necessÃ¡rias para fornecer o valor a ser sacado
//a partir do nÃºmero de notas disponÃ­veis de cada valor
...
programa
{
	...
	{	
		...
		auxvalor = valor
		//armazenando o valor a ser sacado para que nÃ£o se altere
